...
The acquisition and receipt URLs confirm the exact workbook/sheet. The recovered image visibly confirms the cohort and condition. It also resolves a semantic ambiguity: **the selected mode is “Proportion of people,” with a percentage axis**. The alternative “Age-and-sex-specific crude rate (per 1,000)” control is unselected. The filename `F05-Age-specificcruderates` alone does not establish which measure was displayed. This is an age distribution among people with mood disorders, not the alternative crude-rate view.
